...
Here’s a question: if you’ve run an endurance race with friends, would you prefer to share your hugs and high fives at the starting line... Or after you’ve all made it? The terms that we are offering our investors include a "minimum" SAFE Discount. The reason why we can't arrive at our "thankyou" number now is because we don't know what that shared journey will look like with each of our investor partners. For taking the pre-seed venture capital risk, we want to say a big: thank you! But we also want to say thank you for recommending high-performing people for Impulse Collective, or for being able to help in other ways.
