...
At this point we met [Robert Lee](https://fl0wstate.com/robert/), a veteran of venture finance here in San Francisco. Rob is committed to building genuine, lasting human relationships over transactional ones, and his writing on the MFN (Most Favoured Nation) SAFE helped us uncover our answer. MFN pre-seed SAFE terms can be thought of rough as “no worse than seed”, and Rob describes these terms as often being "for investors who don't care" (although they have become more well-known after also being incorporated into [YC's latest finance terms](https://www.ycombinator.com/deal)).

## Thankyou SAFE (or, "Zero-Sum is Zero-Fun") terms 🤗

Here’s a question: if you’ve run an endurance race with friends, would you prefer to share your hugs and high fives at the starting line... Or after you’ve all made it? The terms that we are offering our investors include a "minimum" SAFE Discount, and we call them "Thankyou SAFE" terms. For taking the pre-seed venture capital risk, we want to say a big: thank you! But we also want to say thank you for recommending high-performing people for Impulse Collective, or for being able to help in other ways. The reason why we can't arrive at our "thankyou" number now is because we don't know what that shared journey will look like with each of our investor partners.
...
If MFN terms can be thought of as being "for investors who don't care", we think of our terms as being "for founders who want to say thank you". We're not just looking for a bigger bicep in the same arm-wrestling game. At the end of the day, we understand the economics of VC, and we want to say thank you in a way that makes our investors want to keep on riding with us, well into the future - even for those who can't help any more than bear some of the (disproportionately high!) early-stage venture finance risk.
