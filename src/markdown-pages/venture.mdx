...
Here’s a question: if you’ve run an endurance race with friends, would you prefer to share your hugs and high fives at the starting line... Or after you’ve all made it? With MFN terms, there’s nothing to stop you as a founder offering bonus share grants at seed, so "no worse than seed" needn't translate to "the same as seed". The reason why we can't arrive at a "thankyou" number now is because we don't know what that shared journey will look like with each of our investor partners. For taking the pre-seed venture capital risk, we want to say: thank you. But we also want to say thank you for recommending high-performing people for Impulse Collective, or for being able to help in other ways. We think of these terms as not so much being for "investors who don't care", as being for "founders who want to say thank you".
